...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch LeNet5 with MNIST')
parser.add_argument('--dataset', type=str, default='mnist',
                    help='training dataset (default: mnist)')
parser.add_argument('--scratch', default='./logs/pruned/ratio_7/pruned.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--save', default='./logs/scratch_train/pruned_7', type=str, metavar='PATH',
